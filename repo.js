...
const fetchGitHubRepoDetails = async () => {
  try {
    const _0x1c6838 = await axios.get("https://api.github.com/repos/PeaseErnest12287/roleen");
    const {
      name: _0x4ae93b,
